    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex bg-white border rounded-lg p-1">
                        <button
                            ...
                            className={`px-3 py-1 text-xs rounded-md transition-all ${resolution === '2K' ? 'bg-violet-600 text-white shadow-sm' : 'hover:bg-gray-50'}`}
                        >
                            2K
                        </button>
                        <button
                            onClick={() => setResolution('4K')}
                            className={`px-3 py-1 text-xs rounded-md transition-all ${resolution === '4K' ? 'bg-violet-600 text-white shadow-sm' : 'hover:bg-gray-50'}`}
                        >
                            4K
                        </button>
                    </div>
            ...
            <div className="flex justify-between pt-6 border-t">
                <Link
                    href={`/create/voice?projectId=${projectId}`}
