...
ALTER TABLE projects
  ...
  ADD COLUMN IF NOT EXISTS video_model TEXT NOT NULL DEFAULT 'ltx-2.3-fast',
...
CREATE INDEX IF NOT EXISTS idx_generation_takes_project_id ON generation_takes(project_id);
CREATE INDEX IF NOT EXISTS idx_generation_takes_segment_id ON generation_takes(segment_id);
CREATE INDEX IF NOT EXISTS idx_generation_takes_selected ON generation_takes(segment_id, media_type, is_selected);
