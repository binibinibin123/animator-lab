...
- **Shot Board**: `segments`를 컷 단위 데이터로 사용하고 대사, 화면 설명, 카메라워크, 액션, 조명, 감정, negative prompt를 편집
...
- **Render Compatibility**: Remotion preview/render 구조로 자막, 전환, 오디오 합성 흐름을 연결
...
- Screenshots use dummy/original project data.
